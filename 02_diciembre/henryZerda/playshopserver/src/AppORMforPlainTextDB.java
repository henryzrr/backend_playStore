...
public class AppORMforPlainTextDB implements AppManager {
    ...
    public App findOne(String name) {
        try{
            ...
            return new App(aux[0],aux[1],Estado.valueOf(aux[2]));
        }catch (Exception e){
            return null;
        }
    }
    ...
    public App add(App app) throws IOException {
        dbManager.insert(app.getNombre()+","+app.getVersion()+","+app.getEstado());
        return app;
    }

    @Override
    public App update(App app) throws IOException {
        dbManager.update(app.getNombre()+","+app.getVersion()+","+app.getEstado(),app.getNombre());
        return app;
    }
    ...
    private List<App> convertToAppList(List<String> lines){
        ...
        for (String line:lines
            ...
            apps.add(new App(aux[0],aux[1],Estado.valueOf(aux[2])));
        }
        return apps;
    }
